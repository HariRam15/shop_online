...
import 'package:shop_online/models/http_exception.dart';
...
//if this method was called then the faourites must be shown
  ...
  Future<void> fetchAndSetProduct() async {
    final url = Uri.parse(
        'https://shoponline-a1a4f-default-rtdb.firebaseio.com/products.json');
    try {
  ...
  Future<void> updatrProduct(String id, Product newProduct) async {
